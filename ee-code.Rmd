...
```{r data-import}
Soils <- read_excel("Soil_data.xlsx")
wss_data <- read_excel("wss_data_table_for_crocus_2024.xlsx")
...
tidy_soils 
tidy_soils %>% 
  write_csv("crocus-urban-soil-survey-v1.csv")
```
...
ggsave("neiu_facet_plot.png", width = 12, height = 8)
```
...
ggsave("csu_facet_plot.png", width = 12, height = 8)
```
...
ggsave("uic_facet_plot.png", width = 12, height = 8)
```
